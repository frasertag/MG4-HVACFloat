...
& $apksigner sign `
  ...
  --out (Join-Path $dist "MG4-HVACFloat-V0.5.2.apk") `
  (Join-Path $build "aligned.apk")

& $apksigner verify --verbose (Join-Path $dist "MG4-HVACFloat-V0.5.2.apk")
Get-Item (Join-Path $dist "MG4-HVACFloat-V0.5.2.apk")
